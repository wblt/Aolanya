...
//		[_adView setContentScaleFactor:[[UIScreen mainScreen] scale]];
//		_adView.contentMode =  UIViewContentModeScaleAspectFill;
//		_adView.autoresizingMask = UIViewAutoresizingFlexibleHeight;
//		_adView.clipsToBounds  = YES;
		_adView.contentMode = UIViewContentModeScaleAspectFit;
		_adView.autoresizesSubviews = YES;
		_adView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleTopMargin |  UIViewAutoresizingFlexibleHeight|UIViewAutoresizingFlexibleRightMargin;
