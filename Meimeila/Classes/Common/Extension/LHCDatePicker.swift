...
class LHCDatepicker: UIView {
	...
	private let shadow = UIButton(frame: CGRect(x: 0, y: 0, width: JQScreenwidth, height: JQScreenHeight))
    ...
    private func setupUI(位置: position) {
		...
		let whiteLine = UIView(frame: CGRect(x: 位置 == .底部 ? 0 : 12, y: 位置 == .底部 ? JQScreenHeight - 260 : JQScreenHeight / 2 - 130, width: 位置 == .底部 ? JQScreenwidth : JQScreenwidth - 12 * 2, height: 260))
		...
		确定按钮.frame = CGRect(x: 位置 == .底部 ? JQScreenwidth - 55 : JQScreenwidth - 67, y: 位置 == .底部 ? JQScreenHeight - 260 : JQScreenHeight / 2 - 130, width: 55, height: 45)
        ...
        let frame = CGRect(x: 位置 == .底部 ? 0 : 12, y: 位置 == .底部 ? JQScreenHeight - 215 : JQScreenHeight / 2 - 130 + 45, width: 位置 == .底部 ? JQScreenwidth : JQScreenwidth - 12 * 2, height: 215)
        ...
        let grayLine = UIView(frame: CGRect(x: 位置 == .底部 ? 0 : 12, y: 位置 == .底部 ? JQScreenHeight - 215 : JQScreenHeight / 2 - 130 + 45, width: 位置 == .底部 ? JQScreenwidth : JQScreenwidth - 12 * 2, height: 0.5))
